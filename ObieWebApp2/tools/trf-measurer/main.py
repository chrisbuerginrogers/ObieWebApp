"""
main.py — TRF Measurer entry point.  ≤ 20 lines.
Imports from shared library in ../../py/ (mapped via py-config files block).
All intelligence lives in trf_measurer_logic.py.
"""
import js
